...
def pose_estimation(frame, aruco_dict_type, matrix_coefficients, distortion_coefficients, publisher):
    ...
    #print(f"ids: {ids}")
    if ids is None:
        coordinates = Float32MultiArray(data=[10.0, 0.0, 20.0])  
...
if __name__ == '__main__':
    ...
    rospy.init_node('picamera')
    aruco_publisher = rospy.Publisher('aruco_marker_coordinates', Float32MultiArray, queue_size=10)
    os.system("rosnode kill /laser_Avoidance")
    #os.system("rosnode kill /red_num_node") #yolo.py kill
